...
<nav aria-label="Page navigation">
  <ul class="pagination">
    <li>
    <a href="http://localhost/Dynamicweb/viewpage.php" aria-label="Previous">previous
    </a>
    </li>
...
<div class="col-md-3" >
    <form action="viewbookdetails.php" method="post">
      <button type="submit" class=" btn btn-primary" name="view">View books details</button><br><br>
    </form>
</div>
<div class="col-md-6">
  <form action="viewbookdetails.php" method="POST">
...
if(isset($_GET['id'])){
  ...
  $id=$_GET['id'];
  $userobj = new Dbaction();
  if( $userobj->bookdeleteData($id)==true){
