...
<div class="col-md-3" >
    <form action="viewteachersdetails.php" method="post">
      <button type="submit" class=" btn btn-primary" name="view">View Teachers details</button><br><br>
    </form>
</div>
<div class="col-md-6">
  <form action="viewteachersdetails.php" method="POST">
